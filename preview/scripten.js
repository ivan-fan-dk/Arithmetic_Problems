...
const defaultCalculationTypes = ["Vectors"]; //["Addition", "Subtraction", "Multiplication", "Division"];
const difficulties = ["Beginner", "Easy", "Intermediate", "Hard", "Hell", "Asian"];
const calculationTypes = ["Addition", "Subtraction", "Multiplication", "Division", "Fraction(+-)", "Fraction(*/)", "Linear equation", "Quadratic equation","Vectors"];
