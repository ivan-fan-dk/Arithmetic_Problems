...
const calculationTypes = ["Addition", "Subtraktion", "Multiplikation", "Division", "Brøk(+-)", "Brøk(*/)", "Lineær ligning", "Andengradsligning", "Enhedsomregning", "Vektorer"];
...
const arithmetricProblemsTitleName = "Færdighedsregning";
const timeName = "Tid";
